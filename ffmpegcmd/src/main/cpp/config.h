...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=/usr/ffmpeg/ffmpeg-3.3.7/android/arm --arch=arm --disable-doc --enable-shared --disable-static --disable-yasm --disable-asm --disable-symver --enable-gpl --enable-nonfree --enable-libmp3lame --enable-libx264 --enable-libfdk-aac --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --cross-prefix=/usr/ffmpeg/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --enable-cross-compile --sysroot=/usr/ffmpeg/android-ndk-r14b/platforms/android-14/arch-arm/ --enable-small --extra-cflags='-Os -fpic -marm -I/usr/ffmpeg/x264-snapshot-20180731-2245/android/arm/include -I/usr/ffmpeg/lame-3.100/android/arm/include -I/usr/ffmpeg/fdk-aac-0.1.6/android/arm/include -DANDROID' --extra-ldflags='-L/usr/ffmpeg/x264-snapshot-20180731-2245/android/arm/lib -L/usr/ffmpeg/lame-3.100/android/arm/lib -L/usr/ffmpeg/fdk-aac-0.1.6/android/arm/lib'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/usr/ffmpeg/ffmpeg-3.3.7/android/arm/share/ffmpeg"
#define AVCONV_DATADIR "/usr/ffmpeg/ffmpeg-3.3.7/android/arm/share/ffmpeg"
